...
if user_menu == 'Athlete-wise Analysis':
    athlete_df1 = df.drop_duplicates(subset=['Name','region'])
    
    x1 = athlete_df1['Age'].dropna()
    x2 = athlete_df1[athlete_df1['Medal'] == 'Gold']['Age'].dropna()
    x3 = athlete_df1[athlete_df1['Medal'] == 'Silver']['Age'].dropna()
    x4 = athlete_df1[athlete_df1['Medal'] == 'Bronze']['Age'].dropna()
    ...
    for sport in famous_sports:
        temp_df = athlete_df1[athlete_df1['Sport'] == sport]
